...
_OPENIOC_SEARCH_TO_OBSERVATION_FACTORY = {
    ...
    "Network/IPRange": OBSERVATION_FACTORY_IP_ADDRESS,
    ...
    "RouteEntryItem/Destination": OBSERVATION_FACTORY_DOMAIN_NAME,
    "RouteEntryItem/Destination/IP": OBSERVATION_FACTORY_IP_ADDRESS,
    "RouteEntryItem/Destination/string": OBSERVATION_FACTORY_URL,

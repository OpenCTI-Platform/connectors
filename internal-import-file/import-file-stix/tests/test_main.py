...
import pytest
from connector import ConnectorSettings, ImportFileStix
...
def test_opencti_connector_helper_is_instantiated(mock_opencti_connector_helper):
    ...
    assert helper.connect_name == "ImportFileStix"
    assert helper.connect_scope == "application/json,text/xml"
...
def test_connector_is_instantiated(mock_opencti_connector_helper):
    ...
    connector = ImportFileStix(config=settings, helper=helper)

...
| `connector_only_contextual`          | `CONNECTOR_ONLY_CONTEXTUAL`         | Yes          | `true` Only extract data related to an entity (a report, a threat actor, etc.)                                                                             |
| `connector_auto`                     | `CONNECTOR_AUTO`                    | Yes          | `false` Enable/disable auto import of report file                                                                                                          |

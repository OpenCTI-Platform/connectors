...
| ------------------------------------ | ----------------------------------- | ------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `connector_type`                     | `CONNECTOR_TYPE`                    | Yes          | Must be `INTERNAL_EXPORT` (this is the connector type).                                                                                                    |
...
| `interval`                           | `CONNECTOR_RUN_EVERY`               | Yes          | Number of minutes in which the connections will be performed. E.g.: `30`.                                                                                  |

...
from dummy_enrichment_client import DummyEnrichmentClient
from pycti import OpenCTIConnectorHelper


class DummyEnrichmentConnector:
    """
    ...
    def __init__(self, config: ConnectorSettings, helper: OpenCTIConnectorHelper):
        """
        Initialize `DummyEnrichmentConnector` with its configuration.
        ...
        self.client = DummyEnrichmentClient(
            self.helper,
            base_url=self.config.dummy_enrichment_new.api_base_url,
            api_key=self.config.dummy_enrichment_new.api_key,
    ...
    def extract_and_check_markings(self, opencti_entity: dict) -> None:
        ...
        valid_max_tlp = self.helper.check_max_tlp(
            self.tlp, self.config.dummy_enrichment_new.max_tlp_level
        )

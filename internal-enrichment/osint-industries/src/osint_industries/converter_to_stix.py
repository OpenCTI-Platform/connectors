...
class ConverterToStix:
    ...
    def _build_global_note(self, source_id: str | None):
        ...
        # Attach the note to the discovered accounts via objects= (the source
        # observable is not an SDK object, so we reference the SDK accounts,
        # which are known to the SDK).

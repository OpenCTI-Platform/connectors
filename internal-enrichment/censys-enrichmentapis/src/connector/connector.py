...
from censys_enrichmentapis_client import CensysEnrichmentapisClient


class CensysEnrichmentapisConnector:
    """
    ...
    Attributes:
        ...
        client (CensysEnrichmentapisClient):
    ...
    def __init__(self, config: ConnectorSettings, helper: OpenCTIConnectorHelper):
        """
        Initialize `CensysEnrichmentapisConnector` with its configuration.
        ...
        self.client = CensysEnrichmentapisClient(
            self.helper,
            base_url=self.config.censys_enrichmentapis.api_base_url,
            api_key=self.config.censys_enrichmentapis.api_key,
    ...
    def extract_and_check_markings(self, opencti_entity: dict) -> None:
        ...
        valid_max_tlp = self.helper.check_max_tlp(
            self.tlp, self.config.censys_enrichmentapis.max_tlp_level
        )

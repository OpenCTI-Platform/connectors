...
| DOPPEL_ALERT_TAKEDOWN_ORGANIZATION_CODE | `string` |  | string | `null` | Optional V1 organization workspace code sent as the x-organization-code header. Must be unset for V2. |

"""ReversingLabs Spectra Intelligence Submission connector module."""
...
class ReversingLabsSpectraIntelConnector:
    """ReversingLabs Spectra Intelligence Submission connector."""

    def __init__(self, config: ConnectorSettings, helper: OpenCTIConnectorHelper):
        self.config = config
        self.helper = helper

        cfg = self.config.reversinglabs_spectra_intel_submission

        self.reversinglabs_spectra_intelligence_url = cfg.url
        self.reversinglabs_spectra_intelligence_username = cfg.username
        ...
        self.reversinglabs_poll_interval = cfg.poll_interval
    ...
    def _submit_url_for_analysis(
        ...
        try:
            response = detonate_url.detonate_url(
                url_string=url_sample, platform=self.reversinglabs_sandbox_platform
            )

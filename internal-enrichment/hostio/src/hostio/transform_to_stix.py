...
class BaseStixTransformation:
    ...
    def _create_dns_stix_object_and_relationship(self, record_value, record_type):
        ...
        if stix_object and hasattr(stix_object, "id"):
            ...
            self._create_relationships(source_id=self.entity_id, target_id=stix_object.get("id"), relation_type="resolves-to")
    ...
    def _create_location(self, country, city=None, location_lon_lat=None):
        ...
        self._create_relationships(source_id=self.entity_id, target_id=country_sco.get('id'), relation_type="located-at")
        ...
        self._create_relationships(source_id=city_sco.get('id'), target_id=country_sco.get('id'), relation_type="located-at")
        self._create_relationships(source_id=self.entity_id, target_id=city_sco.get('id'), relation_type="located-at")

...
| HYBRID_ANALYSIS_SANDBOX_ENVIRONMENT_ID | `integer` |  | `400` `310` `300` `200` `160` `120` `110` `100` |  | `110` | Analysis environment ID. Available values: 400=Mac Catalina 64 bit (x86), 310=Linux (Ubuntu 20.04, 64 bit), 300=Linux (Ubuntu 16.04, 64 bit), 200=Android Static Analysis, 160=Windows 10 64 bit, 120=Windows 7 64 bit, 110=Windows 7 32 bit (HWP Support), 100=Windows 7 32 bit. |
...
| HYBRID_ANALYSIS_ENVIRONMENT_ID | `integer` |  | `400` `310` `300` `200` `160` `120` `110` `100` | ⛔️ | `110` | Use HYBRID_ANALYSIS_SANDBOX_ENVIRONMENT_ID instead. (removal scheduled for 2026-12-31) |

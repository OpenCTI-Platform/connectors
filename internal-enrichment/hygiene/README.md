...
| `hygiene_label_name`        | `HYGIENE_LABEL_NAME`               | No        | Label name to be used when labeling matches, by default "hygiene".                                                                                                          |
| `hygiene_label_parent_name` | `HYGIENE_LABEL_PARENT_NAME`        | No        | Label name to be used when enriching sub-domains, by default "hygiene_parent".                                                                                              |
| `hygiene_label_color`       | `HYGIENE_LABEL_PARENT_NAME`        | No        | Color to use for the label(s).                                                                                                                                              |

...
| KASPERSKY_ZONE_OCTI_SCORE_MAPPING | `object` |  | object | `"red:100,orange:80,yellow:60,gray:20,green:0"` | Zone to score mapping. Only the numerical value need to be changed if necessary. See https://tip.kaspersky.com/Help/Doc_data/en-US/AboutZones.htm for further explanations |

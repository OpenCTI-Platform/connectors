...
| XPOSEDORNOT_BASE_URL | `string` |  | Format: [`uri`](https://json-schema.org/understanding-json-schema/reference/string#built-in-formats) | `"https://api.xposedornot.com"` | Base URL of the free XposedOrNot community API. |

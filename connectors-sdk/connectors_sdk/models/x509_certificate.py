...
class X509V3Extensions(BaseObject):
    """X509V3Extensions model."""
    ...
    def to_stix2_object(self) -> stix2.X509V3ExtensionsType:
        """Make stix object."""
        return stix2.v21.observables.X509V3ExtensionsType(
...
class X509Certificate(BaseObservableEntity):
    ...
    x509_v3_extensions: X509V3Extensions | None = Field(
        default=None,
        description="The X.509 v3 extensions of the certificate.",
    )
    ...
    def to_stix2_object(self) -> Stix2X509Certificate:
        ...
        return Stix2X509Certificate(
            ...
            x509_v3_extensions=(
                self.x509_v3_extensions.to_stix2_object()
                if self.x509_v3_extensions
                else None
            ),

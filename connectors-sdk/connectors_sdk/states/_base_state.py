...
from connectors_sdk.logging.logger import logger as connector_logger
...
class BaseConnectorState(BaseModel, ABC):
    ...
    logger: ClassVar[BaseLogger] = connector_logger.get_child("BaseConnectorState")
    ...
    def __init_subclass__(cls, **kwargs: Any) -> None:
        ...
        cls.logger = connector_logger.get_child(cls.__name__)
    ...
    def inject_dependencies(self, helper: OpenCTIConnectorHelper) -> None:
        ...
        self.logger.debug(
            "Dependencies injected into `BaseConnectorState` instance. `_StateClient` set up."
        )

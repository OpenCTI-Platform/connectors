...
def test_ip_v4_address_to_stix2_object_returns_valid_stix_object():
    ...
    # Given: A valid IPV4Address instance with resolves_to and belongs_to refs
    mac_address = MACAddress(value="00:11:22:33:44:55")
    autonomous_system = AutonomousSystem(number=64512)
    ipv4_address = IPV4Address(
        value="0.0.0.0/24",  # explict test with CIDR notation

        ...
        class ConnectorConfigSchemaGenerator(GenerateJsonSchema):
            def generate(self, schema, mode="validation"):
                ...
                if json_schema["title"] == "ConfigLoader":
                    ...
                    return self.flatten_config_loader_schema(
                        self.dereference_schema(json_schema)
                    )
            ...
            def dereference_schema(self, schema_with_refs):
            ...
            def flatten_config_loader_schema(self, root_schema: dict):
                """
                Flatten config loader schema so all config vars are described at root level.

                :param schema_defs: Dictionary of configuration definitions.
                ...
                flat_json_schema = {
                    ...
                    "properties": {},
                    "required": [],
                    "additionalProperties": root_schema.get(
                ...
                for (
                    ...
                    for config_var_name, config_var_schema in config_schema.items():
                        ...
                        config_var_schema.pop(
                            "title", None
                        )  # ? why removing title ? useful for generating the env vars table in README
                        flat_json_schema["properties"][
                            property_name
                        ] = config_var_schema

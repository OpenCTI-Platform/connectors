...
data = [
    (
        ...
        {
            'file': {
                'hash': {'sha256': ['cead3f77f6cda6ec00f57d76c9a6879f', 'abcde3f77f6cda6ec00f57d76c9a6879f']},
    ...
    (
        ...
        {'domain': ['www.5z8.info'], 'ip': ['198.51.100.1/32']}
    ),
    (
    ...
    (
        ...
        {"ip": ["10.2.4.5/32"], "mac": ["d2:fb:49:24:37:18"], "as": {"number": ["15169"]}}
    ),
    (
        ...
        {"ip": ["2001:0db8::/96"], "mac": ["d2:fb:49:24:37:18"],
            "as": {"number": ["15169"]}}
    ),
    (
...
def test_parse(pattern, expected) -> None:
    from stix2ecs import StixIndicator

    indicator = StixIndicator()
    item = indicator.parse_pattern(pattern)[0]

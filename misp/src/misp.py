...
from stix2 import Bundle, Identity, IntrusionSet, Malware, Tool, AttackPattern, Report, Indicator, Relationship, \
    ExternalReference, TLP_WHITE, TLP_GREEN, TLP_AMBER, TLP_RED, ObjectPath, EqualityComparisonExpression, \

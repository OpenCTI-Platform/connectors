...
class TestCTIConverterChronicle(object):
    ...
    # TODO complete test for metadata and udm entities generation
    ...
    # # self.CTIConverter.extract_octi_ioc_url(self.ioc_data).return_value = "/dashboard/observations/indicators/4d34fab3-24a6-4f80-a9bd-1f3e449d65fe"
    # self.mock_helper.patch("CTIConverter.extract_octi_ioc_url",
    ...
    #     "collected_timestamp": self.CTIConverter.current_date(),

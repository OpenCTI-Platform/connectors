...
| SECOPS_SIEM_CLIENT_CERT_URL | `string` | ✅ | string |  | Client x509 certificate URL. |
...
| SECOPS_SIEM_AUTH_URI | `string` |  | string | `"https://accounts.google.com/o/oauth2/auth"` | OAuth2 authorization URI. |
| SECOPS_SIEM_TOKEN_URI | `string` |  | string | `"https://oauth2.googleapis.com/token"` | OAuth2 token URI. |
| SECOPS_SIEM_AUTH_PROVIDER_CERT | `string` |  | string | `"https://www.googleapis.com/oauth2/v1/certs"` | Auth provider x509 certificate URL. |

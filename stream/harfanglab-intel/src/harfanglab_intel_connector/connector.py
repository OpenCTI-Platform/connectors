...
class HarfanglabIntelConnector:
    ...
    def _handle_upsert(self, data: dict, event_context: dict = None) -> None:
    ...
    def _upsert_ioc_rule(self, indicator: opencti.Indicator) -> None:
    ...
    def _upsert_sigma_rule(
        self, indicator: opencti.Indicator, event_context: dict
    ) -> None:
    ...
    def _delete_ioc_rule(self, indicator: opencti.Indicator) -> None:
        for _, observable in indicator.observables:
            ioc_rule = self.stix_converter.create_ioc_rule(indicator, observable)
            existing_ioc_rule = self.api_client.get_ioc_rule(ioc_rule.value)
            if existing_ioc_rule:
    ...
    def _delete_sigma_rule(self, indicator: opencti.Indicator) -> None:
    ...
    def _delete_yara_file(self, indicator: opencti.Indicator) -> None:

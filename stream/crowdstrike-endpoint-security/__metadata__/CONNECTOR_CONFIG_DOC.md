...
| METRICS_ADDR | `string` |  | Format: [`ipv4`](https://json-schema.org/understanding-json-schema/reference/string#built-in-formats) | `"0.0.0.0"` | Bind IP address to use for metrics endpoint. |

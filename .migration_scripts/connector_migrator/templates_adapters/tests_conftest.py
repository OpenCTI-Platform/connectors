...
def get_content(connector_main_path: Path, connector_tests_directory_path: Path) -> str:
    tests_relative_path_segments = os.path.split(
        os.path.relpath(connector_main_path.parent, connector_tests_directory_path)
    )

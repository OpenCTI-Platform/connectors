...
_response_policies_endpoints = [
  [
    ...
    "Search for members of a Response policy in your environment by providing an FQL filter and paging "
  ...
  [
    ...
    "Search for Response Policies in your environment by providing an FQL filter and paging details. Returns a "
    "set of Response Policies which match the filter criteria",
    "response_policies",
    [
      {
        "type": "string",
  ...
  [
    ...
    "Sets the precedence of Response Policies based on the order of IDs specified in the request. The first ID "
  ...
  [
    ...
    "Search for Response Policies in your environment by providing an FQL filter with sort and/or paging "
    "details. This returns a set of Response Policy IDs that match the given criteria.",
    "response_policies",
    [
      {
        "type": "string",

...
| TLP Level        | tlp_level | `CONNECTOR_IPSUM_TLP_LEVEL` |                                                                                | Traffic Light Protocol Marking definition level for ingested objects should be in 'white', 'green', 'amber', 'amber+strict', 'red' |

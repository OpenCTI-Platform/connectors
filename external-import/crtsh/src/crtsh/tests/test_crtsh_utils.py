...
def test_convert_to_datetime():
    ...
    assert isinstance(crtsh.core.crtsh_utils.convert_to_datetime('2021-01-01T00:00:00'), datetime.datetime)
...
def test_is_valid_stix_id():
    assert crtsh.core.crtsh_utils.is_valid_stix_id('indicator--c9bf9e57-1685-4c89-bafb-ff5af830be8a')

def test_is_valid_stix_id_1():
    assert crtsh.core.crtsh_utils.is_valid_stix_id('x509-certificate--79ecd269-b622-550e-aa7f-7074688fe4f8')
...
def test_is_valid_stix_id_6():
    assert not crtsh.core.crtsh_utils.is_valid_stix_id('c9bf9e57-1685-4c89-bafb-ff5af830be8a')
...
def test_is_valid_stix_id_9():
    assert not crtsh.core.crtsh_utils.is_valid_stix_id('indicator--c9bf9e57-1685-4c89-bafb-ff5af830be8a--c9bf9e57-1685-4c89-bafb-ff5af830be8a')

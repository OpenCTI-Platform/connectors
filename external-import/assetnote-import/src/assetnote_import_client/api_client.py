...
class AssetnoteImportClient:
    ...
    def __init__(self, helper: OpenCTIConnectorHelper, base_url: HttpUrl, api_key: SecretStr): 
        self.helper = helper
    ...
    def _graphql_query(self, query: str, root: str, since: str, page: int) -> list[dict]: 
        variables = {
            "page": page, 
            "since": since
        }
        self.helper.connector_logger.debug(f"[API] POST to {self.graphql_url} with variables: {variables}")

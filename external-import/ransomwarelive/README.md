...
| Create Intrusion Set      | `create_intrusion_set`| `CONNECTOR_CREATE_INTRUSION_SET`| False   | No        | Whether to create an Intrusion Set object (Default: false)|
| Create Campaign           | `create_campaign`     | `CONNECTOR_CREATE_CAMPAIGN`     | False   | No        | Whether to create a Campaign object (Default: false)      |
| Create Report             | `create_report`       | `CONNECTOR_CREATE_REPORT`       | False   | No        | Whether to create a Report object (Default: false)        |

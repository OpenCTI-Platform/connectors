...
from requests.exceptions import RetryError, HTTPError, Timeout, ConnectionError
...
@pytest.mark.parametrize(
    ...
    [
        (None, fixture_data_iprepdata, "fixture_data_iprepdata", "iprepdata"), # Status code 200 - Success IPv4 Data
        (None, fixture_data_domainrepdata, "fixture_data_domainrepdata", "domainrepdata"), # Status code 200 - Success Domain Name Data
        (RetryError("Max retries exceeded"), # Status Code 429, 500, 502, 503, 504 - Error
         {
             "error": "Max retries exceeded",
             "message": "[CONNECTOR-API] A retry error occurred during data recovery, maximum retries exceeded for url"
         }, "fixture_data_iprepdata", "iprepdata"),
...
def test_fetch_data(mocker, side_effect, expected_result, fixture_data, data_name,  request, mock_helper, mock_config):
    """

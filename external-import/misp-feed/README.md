...
| MISP Feed HTTP Authorization Header        | misp_feed.http_authorization_header                          | MISP_FEED_HTTP_AUTHORIZATION_HEADER                          |            | No        | Sets a static authorization header if needed                     |

...
def test_opencti_connector_helper_is_instantiated(mock_opencti_connector_helper):
    ...
    assert helper.connect_id == "d790f4c0-84c1-4e91-8e6b-3a6f3a0e1234"
    assert helper.connect_name == "Elastic Security Incidents"
    assert helper.connect_scope == "elastic-security-incidents"
...
def test_connector_is_instantiated(mock_opencti_connector_helper, monkeypatch):
    ...
    """
    monkeypatch.setattr(
        "connector.client_api.ElasticApiClient.test_connection",

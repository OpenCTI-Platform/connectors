        ...
        if len(bundle) > 0:
            ...
            for stix_object in bundle:
                ...
                if (
                    ...
                    stix_object["relationship_type"] = "attributed_to"
                ...
                if (
                    stix_object.get("relationship_type", "") == "associated_content"
                    and stix_object.get("target_ref").startswith("threat-actor--")
                    and stix_object.get("target_ref").startswith("malware--")
                ):
                ...
                if stix_object.get(
                    "relationship_type", ""
                ) == "associated_content" and stix_object.get("target_ref").startswith(
                    "threat-actor--"
                ):
                    continue

...
from pycti.entities.opencti_threat_actor_individual import ThreatActorIndividual as PyctiTAI
...
class MandiantAlertsConnector(ExternalImportConnector):
    ...
    def _getTweetObjects(self, doc: dict, doc_url: str) -> []:
        ...
        if x_author_id:
            x_relationship = Relationship(
                    id=PyctiSCR.generate_id("related-to", x_media_content["id"], x_author_id, None, None),
    ...
    def _getMessageObjects(self, doc: dict, doc_url: str) -> []:
        ...
        if channel_id:
            x_relationship = Relationship(
                    id=PyctiSCR.generate_id("related-to", x_media_content["id"], channel_id, None, None),
                    relationship_type="related-to",
                    source_ref=x_media_content["id"],
    ...
    def _getShopListingObjects(self, doc: dict, doc_url: str) -> []:
        ...
        if x_seller:
            x_relationship = Relationship(
                    id=PyctiSCR.generate_id("related-to", x_media_content["id"], x_actor["id"], None, None),
                    relationship_type="related-to",
                    source_ref=x_media_content["id"],
    ...
    def _getCompromisedCredentialsObjects(self, doc: dict, doc_url: str) -> []:
        ...
        # relationship
        x_relationship = Relationship(
                id=PyctiSCR.generate_id("related-to", x_account["id"], x_file["id"], None, None),
                relationship_type="related-to",

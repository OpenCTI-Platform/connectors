...
| CONNECTOR_SCOPE | `array` |  | string | `["Indicator", "IPv4-Addr", "Url"]` | The scope of the connector, i.e. the entity types it imports. |
...
| HONEYLABS_PAGE_SIZE | `integer` |  | `1 <= x <= 1000` | `500` | Objects requested per TAXII page. |

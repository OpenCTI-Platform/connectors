...
class ConnectorContractGenerator:
    ...
    def __init__(self):
        self.connector_infos_filename = "connector_infos.json"
        self.connector_schema_filename = "connector_schema.json"
        self.connector_model_configs = (
    ...
    def load_connector_infos(self) -> dict:
        ...
        filepath = os.path.join(
            os.path.dirname(__file__), "__infos__", self.connector_infos_filename
        )
    ...
    def make_connector_configurations(self, base_schema: dict, definitions) -> dict:
        ...
        base_schema = {
            key: base_schema[key]
            for key in keys_to_extract_from_base
        ...
        class ConnectorCustomSchemaGenerator(GenerateJsonSchema):
            def generate(self, schema, mode="validation"):
                ...
                if json_schema["properties"]:
                    ...
                    connector_infos_json = (
                        connector_infos_json | connector_configurations
                    )
    ...
    def create_connector_contract(self):
        ...
        filepath = os.path.join(
            os.path.dirname(__file__), "__infos__", self.connector_schema_filename
        )

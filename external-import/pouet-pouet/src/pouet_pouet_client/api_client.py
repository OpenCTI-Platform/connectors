...
class PouetPouetClient:
    ...
    def get_indicators(self) -> list[dict]:
        """
        Retrieve all indicators from the API.
        :return: A list of dicts representing the complete collection of indicators from the API
        """
        return [
            {"id": 789, "type": "url", "name": "http://example.com"},
            {"id": 101112, "type": "domain-name", "name": "example.org"},
        ]

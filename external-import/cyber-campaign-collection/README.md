...
| Report Type   | cyber_monitor.report_type   | `CYBER_MONITOR_REPORT_TYPE`    |         | No        | Optional STIX `report_types` value attached to imported reports (e.g. `threat-report`). When unset, no report type is emitted.                                                             |

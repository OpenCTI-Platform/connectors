...
class MitreAtlas:
    ...
    def __init__(self):
        ...
        # Extra config
        self.mitre_atlas_file_url = get_config_variable(
            "MITRE_ATLAS_URL", ["mitre_atlas", "url"], config
        )
        self.mitre_atlas_interval = get_config_variable(
            "MITRE_ATLAS_INTERVAL", ["mitre_atlas", "interval"], config, True
        )
    ...
    def process_data(self):
        try:
            ...
            if last_run is None or (
                ...
                # Get MITRE ATLAS STIX 2.1 JSON data
                if (

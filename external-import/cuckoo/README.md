...
## Description
This is a connector for syncing Cuckoo sandbox analysis as reports and IOCs to [OpenCTI](https://github.com/OpenCTI-Platform/opencti).
...
| CUCKOO_INTERVAL               | interval                 | How often to poll for new jobs
| CUCKOO_CREATE_INDICATORS      | create_indicators        | Create Indicators for Observables
| CUCKOO_ENABLE_REGISTRY_KEYS   | enable_registry_keys     | Create Registry Observables for created registry keys
| CUCKOO_ENABLE_NETWORK_TRAFFIC | enable_network_traffic   | Create NetworkTraffic Observables

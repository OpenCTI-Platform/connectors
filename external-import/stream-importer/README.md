...
| `perfect_sync`               | `PERFECT_SYNC`                   | false     | No        | If set, events received can overwrite data.                                                                                                                                   |
| `metrics_namespace`          | `METRICS_NAMESPACE`              |           | No        | Namespace for the metrics.                                                                                                                                                    |
| `metrics_subsystem`          | `METRICS_SUBSYSTEM`              |           | No        | Subsystem for the metrics.                                                                                                                                                    |
...
| `minio_src_recurse`          | `MINIO_SRC_RECURSE`              | false     | No        | Set to true to list files in all subfolders.                                                                                                                                  |
...
| `minio_secure`               | `MINIO_SECURE`                   | true      | No        | Whether to use SSL or not.                                                                                                                                                    |
| `minio_cert_check`           | `MINIO_CERT_CHECK`               | true      | No        | Whether to check certificate.                                                                                                                                                 |

...
def expected_log_messages() -> list[str]:
    ...
    return [
        ...
        "[Orchestrator] (1/1) Found relationships {malware_families: 1, threat_actors: 1, attack_techniques: 1, vulnerabilities: 1, software_toolkits: 1, domains: 1, files: 1, urls: 1, ip_addresses: 1}",
        "[Fetchers] Fetching details for 9 subentities...",
        ...
        "[Orchestrator] (1/1) Converted to 103 STIX entities {identity: 23, report: 1, malware: 1, intrusion-set: 1, location: 17, relationship: 50, attack-pattern: 1, vulnerability: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1}",
        "[GenericBatchProcessor] Flushing remaining 105 STIX objects",
        "[GenericBatchProcessor] Processing batch #1 with 105 STIX objects (Total processed: 105)",
        "[GenericBatchProcessor] Sent batch #1 to OpenCTI",
        "[GenericBatchProcessor] Batch None completed successfully: 105 objects (identity: 24, marking-definition: 1, report: 1, malware: 1, intrusion-set: 1, location: 17, relationship: 50, attack-pattern: 1, vulnerability: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1)",
        "[GenericBatchProcessor] Successfully processed batch #1. Total STIX objects sent: 105",

...
def test_gti_file_to_stix_minimal_data(
    ...
    # Then only file observable should be created (no verdict = no indicator)
    assert len(stix_objects) == 1  # noqa: S101
    file_observable = stix_objects[0]
...
def test_gti_file_to_stix_with_benign_verdict(
    ...
    # Then only file observable should be created (benign verdict = no indicator)
    assert len(stix_objects) == 1  # noqa: S101
    file_observable = stix_objects[0]
    assert file_observable is not None  # noqa: S101
...
def test_gti_file_to_stix_without_attributes(
    ...
    # Then only file observable should be created (no attributes = no indicator)
    assert len(stix_objects) == 1  # noqa: S101
    file_observable = stix_objects[0]
    assert file_observable is not None  # noqa: S101
...
def test_gti_file_to_stix_with_empty_verdict(
    ...
    # Then only file observable should be created (empty verdict = no indicator)
    assert len(stix_objects) == 1  # noqa: S101
    file_observable = stix_objects[0]
    assert file_observable is not None  # noqa: S101

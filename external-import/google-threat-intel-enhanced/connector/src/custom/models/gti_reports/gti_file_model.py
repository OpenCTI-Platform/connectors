...
class LastAnalysisResult(BaseModel):
    ...
    engine_update: Union[str, int, None] = Field(
        None, description="Date of the engine update (string or Unix timestamp)."
    )
...
class FileModel(BaseModel):
    ...
    popular_threat_name: Optional[List[PopularThreatName]] = Field(
        None, description="Popular threat/malware names detected for this file."
    )

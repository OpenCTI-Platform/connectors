...
This module defines Pydantic models for parsing GTI campaign API responses.
"""
...
class FilesAggregation(BaseModel):
    ...
    suggested_threat_label: Optional[Any] = Field(
...
class TargetedIndustry(BaseModel):
    ...
    industry_group: Optional[str] = Field(
        default=None, description="Industry group targeted by the campaign"
    )
    last_seen: Optional[int] = Field(
        default=None,
...
class CampaignModel(BaseModel):
    ...
    creation_date: Optional[int] = Field(
        default=None, description="Campaign object creation date (UTC timestamp)"
    )
    description: Optional[str] = Field(

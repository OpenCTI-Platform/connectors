...
import pytest
from connector import ConnectorSettings, URLHausRecentPayloads
        ...
        return handler(
            {
                ...
                "urlhaus_recent_payloads": {
                    ...
                    "include_filetypes": "exe,zip,dll,docm,docx,doc,xls,xlsx,xlsm,js,xll",
                    "include_signatures": "",
                    "skip_unknown_filetypes": True,
                    "skip_null_signature": True,
                    "labels": "urlhaus",
                    "labels_color": "#54483b",
                    "signature_label_color": "#0059f7",
                    "filetype_label_color": "#54483b",
                },
            }
        )
...
def test_connector_is_instantiated(mock_opencti_connector_helper):
    ...
    connector = URLHausRecentPayloads(config=settings, helper=helper)

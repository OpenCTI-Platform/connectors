...
class ConnectorRosti:
    ...
    def _collect_intelligence(self, since: str) -> list:
        ...
        :param since: date from which to import the reports
        ...
        entities = self.client.get_reports(since)
    ...
    def process_message(self) -> None:
        ...
        try:
            ...
            if current_state is not None and "last_run" in current_state:
                ...
                duration = isodate.parse_duration(self.config.relative_import_start_date)
            ...
            friendly_name = "Connector Rösti feed"
            ...
            # === Add your code below ===
            # ===========================
            stix_objects = self._collect_intelligence(last_run[:10])

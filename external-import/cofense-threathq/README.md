...
| Api base url                 | `api_base_url`      | `COFENSE_THREATHQ_API_BASE_URL`      | ``             | No        | Cofense ThreatHQ API base url used for REST requests.                                                                                                               |
...
| Impact to exclude            | `impact_to_exclude` | `COFENSE_THREATHQ_STATE_TO_EXCLUDE`  | `No exclusion` | No        | List of report impact to exclude from import. Example: "None,Moderate,Major"                                                                                        |
| TLP level                    | `tlp_level`         | `COFENSE_THREATHQ_TLP_LEVEL`         | `red`          | No        | TLP markings for exported data (Available: clear, green, amber, amber+strict, red)                                                                                  |

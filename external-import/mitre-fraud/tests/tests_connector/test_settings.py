        ...
        pytest.param(
            {
                ...
                "connector": {
                    ...
                    "scope": "attack-pattern,identity,marking-definition,relationship",
                    "log_level": "error",
                    "duration_period": "PT1H",
                },
                "mitre_fraud": {
                    "remove_statement_marking": False,
                },
            },
...
def test_settings_should_accept_valid_input(settings_dict):
    ...
    assert isinstance(settings.mitre_fraud, BaseConfigModel) is True

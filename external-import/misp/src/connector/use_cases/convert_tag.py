...
class TagConverter:
    def __init__(self, config: ConverterConfig, threats_guesser: ThreatsGuesser):
        self.config = config
    ...
    def create_custom_marking(self, tag: TagItem) -> stix2.MarkingDefinition:
    ...
    def guess_threats(
        ...
        threat = threats[0]  # TODO: loop over all threats?
    ...
    def process(
        ...
        if self.config.guess_threats_from_tags:
            ...
            added_names.extend([stix_object["name"] for stix_object in stix_objects])
        ...
        for attack_pattern in attack_patterns:
            threats = malwares or intrusion_sets or []

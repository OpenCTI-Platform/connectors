...
from typing import (Any, Callable, Dict, Generator, List, Mapping, NamedTuple,
...
from .constants import (DEFAULT_X_OPENCTI_SCORE,
                        TLP_MARKING_DEFINITION_MAPPING, X_OPENCTI_ALIASES,
                        X_OPENCTI_FILES, X_OPENCTI_LOCATION_TYPE,
                        X_OPENCTI_MAIN_OBSERVABLE_TYPE,
                        X_OPENCTI_REPORT_STATUS, X_OPENCTI_SCORE, T)
from .indicators import (
    ...
    create_indicator_pattern_ip_address_block, create_indicator_pattern_mutex,
...
from .observables import (ObservableProperties,
                          ...
                          create_observable_mutex, create_observable_url,

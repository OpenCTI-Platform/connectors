...
class Breach(FrozenBaseModel):
    ...
    basetypes: list[str] = Field(
        description='Underlying base type of breach object (e.g. ["breach"])',
    )
...
class CompromisedCredentialSighting(FrozenBaseModel):
    ...
    basetypes: list[str] = Field(
        description='Underlying type of this object (e.g. ["credential-sighting"])',
        default=[],
    )
    body: str = Field(

"""Common fixtures for ctm360-cyna-feed tests."""
...
def _set_required_env_vars(monkeypatch):
    ...
    monkeypatch.setenv("CONNECTOR_NAME", "CTM360-CYNA")
    monkeypatch.setenv("CONNECTOR_SCOPE", "ctm360-cyna")
    monkeypatch.setenv("CONNECTOR_DURATION_PERIOD", "PT24H")

    # Connector-specific required settings
    monkeypatch.setenv("CTM360_CYNA_API_KEY", "test-api-key")

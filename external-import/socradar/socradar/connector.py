...
collection_catalog = ["collection_1", "collection_2", "collection_3", "collection_4", "collection_5", "collection_6", "collection_7", "collection_8", "collection_9", "collection_10", "collection_11", "collection_12", "collection_13", "collection_14"]
...
regex_patterns = {
    ...
    'domain': re.compile(r'^(?=.{1,255}$)(?:[A-Za-z0-9](?:[A-Za-z0-9-]{0,61}[A-Za-z0-9])?\.)+[A-Za-z]{2,6}$'),
            ...
            if observable_type and pattern and observableData:
                try:
                    ...
                    if observable is None:
                        ...
                        logger.info(f"Created observable: {observable.get('id', 'No ID returned')}")
                except Exception as e:
                    logger.error(f"Error creating indicator or observable: {str(e)}", exc_info=True)
            else:

# OpenCTI Snort Connector

<!-- 
 
* Import snort alert logs into OpenCTI
* Either run from snort box or copy alert log to docker image 
* Requires alert logs generated by snort

...
| MICROSOFT_SENTINEL_INCIDENTS_RESOURCE_GROUP | `string` |  | string | `null` | Your Microsoft Sentinel resource group. |
| MICROSOFT_SENTINEL_INCIDENTS_IMPORT_START_DATE | `string` |  | string | `"2020-01-01T00:00:00Z"` | Import starting date (in YYYY-MM-DD format or YYYY-MM-DDTHH:MM:SSZ format) - used only if connector's state is not set. |

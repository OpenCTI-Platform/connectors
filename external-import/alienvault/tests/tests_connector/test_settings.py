        ...
        pytest.param(
            {
                ...
                "alienvault": {
                    ...
                    "pulse_start_timestamp": "2020-05-01T00:00:00",
                    "report_type": "threat-report",
                    "report_status": "New",
                    "guess_malware": False,
                    "guess_cve": False,
                    "excluded_pulse_indicator_types": "FileHash-MD5,FileHash-SHA1",
                    "enable_relationships": True,
                    "enable_attack_patterns_indicates": False,
                    "filter_indicators": False,
                    "default_x_opencti_score": 50,
                    "x_opencti_score_ip": 60,
                    "x_opencti_score_domain": 70,
                    "x_opencti_score_hostname": 75,
                    "x_opencti_score_email": 70,
                    "x_opencti_score_file": 80,
                    "x_opencti_score_url": 80,
                    "x_opencti_score_mutex": 60,
                    "x_opencti_score_cryptocurrency_wallet": 80,
                    "interval_sec": "1800",
                },
            },
...
def test_settings_should_accept_valid_input(settings_dict):
    ...
    assert isinstance(settings.alienvault, BaseConfigModel) is True

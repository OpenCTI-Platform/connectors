...
class AlienVault:
    ...
    def __init__(
        ...
        default_x_opencti_score = (
            self.config.alienvault.default_x_opencti_score
            or self._DEFAULT_DEFAULT_X_OPENCTI_SCORE
        )
        x_opencti_score_ip = (
            self.config.alienvault.x_opencti_score_ip or default_x_opencti_score
        )
        x_opencti_score_domain = (
            self.config.alienvault.x_opencti_score_domain or default_x_opencti_score
        )
        x_opencti_score_hostname = (
            self.config.alienvault.x_opencti_score_hostname or default_x_opencti_score
        )
        x_opencti_score_email = (
            self.config.alienvault.x_opencti_score_email or default_x_opencti_score
        )
        x_opencti_score_file = (
            self.config.alienvault.x_opencti_score_file or default_x_opencti_score
        )
        x_opencti_score_url = (
            self.config.alienvault.x_opencti_score_url or default_x_opencti_score
        )
        x_opencti_score_mutex = (
            self.config.alienvault.x_opencti_score_mutex or default_x_opencti_score
        )

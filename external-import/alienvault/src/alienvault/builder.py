...
from alienvault.utils import (OBSERVATION_FACTORY_CRYPTOCURRENCY_WALLET,
                              ...
                              ObservationFactory, create_attack_pattern,
                              create_attack_pattern_external_reference,
                              create_based_on_relationships, create_country,
                              create_external_reference,
                              create_indicates_relationships, create_indicator,
                              create_intrusion_set, create_malware,
                              create_object_refs, create_organization,
                              create_report, create_sector,

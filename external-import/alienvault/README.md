...
| Filter Indicators                     | `filter_indicators`                | `ALIENVAULT_FILTER_INDICATORS`                | `False`                      | No        | This boolean filters out indicators created before the latest pulse datetime, ensuring only recent indicators are processed.   |

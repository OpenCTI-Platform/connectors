...
def config_dict() -> dict[str, Any]:
    return {
        ...
        "obstracts": {
            "base_url": "https://test-obstracts-url/",
...
def mock_session(mocker: MockerFixture) -> MagicMock:
    session = MagicMock()
    mocker.patch("obstracts.requests.Session", return_value=session)
    return session

...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'attack techniques'}",
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'vulnerabilities'}",
        "Fetched details - {'prefix': '[FetcherShared]', 'summary': 'malware_families: 1, attack_techniques: 1, vulnerabilities: 1'}",
        ...
        "Converted to STIX entities - {'prefix': '[OrchestratorThreatActor]', 'current': 1, 'total': 1, 'entities_count': 91, 'entities_summary': 'location: 17, identity: 25, intrusion-set: 1, relationship: 45, malware: 1, attack-pattern: 1, vulnerability: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 91, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 91, 'total_count': 91, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 93, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 93, 'display_name': 'STIX objects', 'total_processed': 93}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 93, 'type_summary': 'identity: 26, marking-definition: 1, location: 17, intrusion-set: 1, relationship: 45, malware: 1, attack-pattern: 1, vulnerability: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 93 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 93}",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'attack techniques'}",
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'vulnerabilities'}",
        "Fetched details - {'prefix': '[FetcherShared]', 'summary': 'threat_actors: 1, attack_techniques: 1, vulnerabilities: 1'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 54, 'entity_type': 'threat actors'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'vulnerabilities'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorMalware]', 'current': 1, 'total': 1, 'entities_count': 91, 'entities_summary': 'identity: 25, malware: 1, relationship: 45, location: 17, intrusion-set: 1, attack-pattern: 1, vulnerability: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 91, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 91, 'total_count': 91, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 93, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 93, 'display_name': 'STIX objects', 'total_processed': 93}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 93, 'type_summary': 'identity: 26, marking-definition: 1, malware: 1, relationship: 45, location: 17, intrusion-set: 1, attack-pattern: 1, vulnerability: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 93 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 93}",
...
def expected_vulnerability_log_messages_no_software() -> list[str]:
    ...
    return [
        ...
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'attack techniques'}",
        "Fetched entities - {'prefix': '[GenericFetcher]', 'count': 1, 'entity_type': 'threat actors'}",
        "Fetched details - {'prefix': '[FetcherShared]', 'summary': 'malware_families: 1, attack_techniques: 1, threat_actors: 1'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 34, 'entity_type': 'malware families'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 54, 'entity_type': 'threat actors'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 92, 'entities_summary': 'vulnerability: 1, note: 1, identity: 25, malware: 1, relationship: 45, attack-pattern: 1, location: 17, intrusion-set: 1'}",
...
def expected_vulnerability_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 54, 'entity_type': 'threat actors'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 140, 'entities_summary': 'vulnerability: 1, software: 24, note: 1, relationship: 69, identity: 25, malware: 1, attack-pattern: 1, location: 17, intrusion-set: 1'}",

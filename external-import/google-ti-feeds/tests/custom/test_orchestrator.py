...
def expected_report_log_messages() -> list[str]:
    ...
    return [
        ...
        "Found relationships - {'prefix': '[OrchestratorReport]', 'current': 1, 'total': 1, 'relationships': 'malware_families: 1, threat_actors: 1, attack_techniques: 1, vulnerabilities: 1, campaigns: 1, domains: 1, files: 1, urls: 1, ip_addresses: 1, software_toolkits: 1'}",
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 1, 'entity_type': 'software toolkits'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorReport]', 'current': 1, 'total': 1, 'entities_count': 198, 'entities_summary': 'identity: 48, report: 1, malware: 1, relationship: 85, location: 23, intrusion-set: 1, vulnerability: 1, software: 24, note: 3, campaign: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1, tool: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 198, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 198, 'total_count': 198, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 200, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 200, 'display_name': 'STIX objects', 'total_processed': 200}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 200, 'type_summary': 'identity: 49, marking-definition: 1, report: 1, malware: 1, relationship: 85, location: 23, intrusion-set: 1, vulnerability: 1, software: 24, note: 3, campaign: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1, tool: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 200 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 200}",
...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "Fetched 1 vulnerabilities relationships from API - {'prefix': '[BaseFetcher]'}",
        "Fetched 1 software_toolkits relationships from API - {'prefix': '[BaseFetcher]'}",
        "Found relationships - {'prefix': '[OrchestratorThreatActor]', 'current': 1, 'total': 1, 'relationships': 'malware_families: 1, attack_techniques: 1, vulnerabilities: 1, software_toolkits: 1'}",
        ...
        "Converted to STIX entities - {'prefix': '[OrchestratorThreatActor]', 'current': 1, 'total': 1, 'entities_count': 144, 'entities_summary': 'location: 17, identity: 25, intrusion-set: 1, relationship: 70, malware: 1, vulnerability: 1, software: 24, note: 3, tool: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 144, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 144, 'total_count': 144, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 146, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 146, 'display_name': 'STIX objects', 'total_processed': 146}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 146, 'type_summary': 'identity: 26, marking-definition: 1, location: 17, intrusion-set: 1, relationship: 70, malware: 1, vulnerability: 1, software: 24, note: 3, tool: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 146 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 146}",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 53, 'entity_type': 'vulnerabilities'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorMalware]', 'current': 1, 'total': 1, 'entities_count': 142, 'entities_summary': 'identity: 25, malware: 1, relationship: 69, location: 17, intrusion-set: 1, vulnerability: 1, software: 24, note: 3, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 142, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 142, 'total_count': 142, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 144, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 144, 'display_name': 'STIX objects', 'total_processed': 144}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 144, 'type_summary': 'identity: 26, marking-definition: 1, malware: 1, relationship: 69, location: 17, intrusion-set: 1, vulnerability: 1, software: 24, note: 3, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 144 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 144}",
...
def expected_vulnerability_log_messages_no_software() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 54, 'entity_type': 'threat actors'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 94, 'entities_summary': 'vulnerability: 1, note: 3, identity: 25, malware: 1, relationship: 45, location: 17, intrusion-set: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 94, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 94, 'total_count': 94, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 96, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 96, 'display_name': 'STIX objects', 'total_processed': 96}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 96, 'type_summary': 'identity: 26, marking-definition: 1, vulnerability: 1, note: 3, malware: 1, relationship: 45, location: 17, intrusion-set: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 96 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 96}",
...
def expected_vulnerability_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 54, 'entity_type': 'threat actors'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 142, 'entities_summary': 'vulnerability: 1, software: 24, note: 3, relationship: 69, identity: 25, malware: 1, location: 17, intrusion-set: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 142, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 142, 'total_count': 142, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 144, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 144, 'display_name': 'STIX objects', 'total_processed': 144}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 144, 'type_summary': 'identity: 26, marking-definition: 1, vulnerability: 1, software: 24, note: 3, relationship: 69, malware: 1, location: 17, intrusion-set: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 144 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 144}",
        "State update: Setting next_cursor_date - {'prefix': '[GenericBatchProcessor]', 'latest_date': '2025-06-25T08:22:55+00:00'}",
    ]

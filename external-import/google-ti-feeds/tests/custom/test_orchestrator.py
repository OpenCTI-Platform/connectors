...
def expected_log_messages() -> list[str]:
    ...
    return [
        ...
        "[GenericConverter] Converted 1 domains to STIX format",
        "[GenericConverter] Converted 1 files to STIX format",
        "[GenericConverter] Converted 1 URLs to STIX format",
        "[GenericConverter] Converted 1 IP addresses to STIX format",
        "[Orchestrator] (1/1) Converted to 23 STIX entities {identity: 14, report: 1, malware: 1, intrusion-set: 1, attack-pattern: 1, vulnerability: 1, domain-name: 1, file: 1, url: 1, ipv4-addr: 1}",
        "[GenericBatchProcessor] Flushing remaining 23 STIX objects",
        "[GenericBatchProcessor] Processing batch #1 with 23 STIX objects (Total processed: 23)",
        "[GenericBatchProcessor] Sent batch #1 to OpenCTI",
        "[GenericBatchProcessor] Batch None completed successfully: 23 objects (identity: 14, report: 1, malware: 1, intrusion-set: 1, attack-pattern: 1, vulnerability: 1, domain-name: 1, file: 1, url: 1, ipv4-addr: 1)",
        "[GenericBatchProcessor] Successfully processed batch #1. Total STIX objects sent: 23",

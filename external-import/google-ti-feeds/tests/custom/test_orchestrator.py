...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "[OrchestratorThreatActor] (1/1) Converted to 107 STIX entities {location: 17, identity: 39, intrusion-set: 1, relationship: 46, malware: 1, report: 1, attack-pattern: 1, vulnerability: 1}",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "[GenericConverter] Converted 2 attack techniques to STIX format",
        "[GenericConverter] Converted 2 vulnerabilities to STIX format",
        "[OrchestratorMalware] (1/1) Converted to 107 STIX entities {identity: 39, malware: 1, relationship: 46, location: 17, intrusion-set: 1, report: 1, attack-pattern: 1, vulnerability: 1}",
        "[GenericBatchProcessor] Flushing remaining 109 STIX objects",
        "[GenericBatchProcessor] Processing batch #1 with 109 STIX objects (Total processed: 109)",
        "[GenericBatchProcessor] Sent batch #1 to OpenCTI",

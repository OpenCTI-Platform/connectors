...
class DummyConfig:
    ...
    def __init__(
        ...
        self.campaign_import_start_date = "P1D"
...
def expected_report_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted to STIX entities - {'prefix': '[OrchestratorReport]', 'current': 1, 'total': 1, 'entities_count': 148, 'entities_summary': 'identity: 48, report: 1, malware: 1, relationship: 63, location: 23, intrusion-set: 1, vulnerability: 1, campaign: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 148, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 148, 'total_count': 148, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 150, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 150, 'display_name': 'STIX objects', 'total_processed': 150}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 150, 'type_summary': 'identity: 49, marking-definition: 1, report: 1, malware: 1, relationship: 63, location: 23, intrusion-set: 1, vulnerability: 1, campaign: 1, domain-name: 1, indicator: 4, file: 1, url: 1, ipv4-addr: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 150 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 150}",
...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted to STIX entities - {'prefix': '[OrchestratorThreatActor]', 'current': 1, 'total': 1, 'entities_count': 125, 'entities_summary': 'location: 23, identity: 34, intrusion-set: 1, relationship: 63, malware: 1, vulnerability: 1, campaign: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 125, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 125, 'total_count': 125, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 127, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 127, 'display_name': 'STIX objects', 'total_processed': 127}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 127, 'type_summary': 'identity: 35, marking-definition: 1, location: 23, intrusion-set: 1, relationship: 63, malware: 1, vulnerability: 1, campaign: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 127 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 127}",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 34, 'entity_type': 'Campaigns'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorMalware]', 'current': 1, 'total': 1, 'entities_count': 125, 'entities_summary': 'identity: 34, malware: 1, relationship: 63, location: 23, intrusion-set: 1, vulnerability: 1, campaign: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 125, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 125, 'total_count': 125, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 127, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 127, 'display_name': 'STIX objects', 'total_processed': 127}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 127, 'type_summary': 'identity: 35, marking-definition: 1, malware: 1, relationship: 63, location: 23, intrusion-set: 1, vulnerability: 1, campaign: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 127 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 127}",

...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "[OrchestratorThreatActor] (1/1) Found relationships {malware_families: 1, reports: 1, attack_techniques: 1, vulnerabilities: 1}",
        "[FetcherShared] Fetching details for 4 subentities...",
        "[GenericFetcher] Fetched 1 malware families",
        "[GenericFetcher] Fetched 1 reports",
        "[GenericFetcher] Fetched 1 attack techniques",
        "[GenericFetcher] Fetched 1 vulnerabilities",
        "[FetcherShared] Fetched details {malware_families: 1, reports: 1, attack_techniques: 1, vulnerabilities: 1}",
        "[GenericConverter] Converted 34 malware families to STIX format",
        "[GenericConverter] Converted 15 reports to STIX format",
        "[GenericConverter] Converted 2 attack techniques to STIX format",
        "[GenericConverter] Converted 2 vulnerabilities to STIX format",
        "[OrchestratorThreatActor] (1/1) Converted to 106 STIX entities {location: 17, identity: 39, intrusion-set: 1, relationship: 45, malware: 1, report: 1, attack-pattern: 1, vulnerability: 1}",
        "[GenericBatchProcessor] Flushing remaining 108 STIX objects",
        "[GenericBatchProcessor] Processing batch #1 with 108 STIX objects (Total processed: 108)",
        "[GenericBatchProcessor] Sent batch #1 to OpenCTI",
        "[GenericBatchProcessor] Batch None completed successfully: 108 objects (identity: 40, marking-definition: 1, location: 17, intrusion-set: 1, relationship: 45, malware: 1, report: 1, attack-pattern: 1, vulnerability: 1)",
        "[GenericBatchProcessor] Successfully processed batch #1. Total STIX objects sent: 108",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "[OrchestratorMalware] (1/1) Found relationships {threat_actors: 1, reports: 1, attack_techniques: 1, vulnerabilities: 1}",
        "[FetcherShared] Fetching details for 4 subentities...",
        "[GenericFetcher] Fetched 1 threat actors",
        "[GenericFetcher] Fetched 1 reports",
        "[GenericFetcher] Fetched 1 attack techniques",
        "[GenericFetcher] Fetched 1 vulnerabilities",
        "[FetcherShared] Fetched details {threat_actors: 1, reports: 1, attack_techniques: 1, vulnerabilities: 1}",
        "[GenericConverter] Converted 54 threat actors to STIX format",
        "[GenericConverter] Converted 15 reports to STIX format",
        "[GenericConverter] Converted 2 attack techniques to STIX format",
        "[GenericConverter] Converted 2 vulnerabilities to STIX format",
        "[OrchestratorMalware] (1/1) Converted to 106 STIX entities {identity: 39, malware: 1, relationship: 45, location: 17, intrusion-set: 1, report: 1, attack-pattern: 1, vulnerability: 1}",
        "[GenericBatchProcessor] Flushing remaining 108 STIX objects",
        "[GenericBatchProcessor] Processing batch #1 with 108 STIX objects (Total processed: 108)",
        "[GenericBatchProcessor] Sent batch #1 to OpenCTI",
        "[GenericBatchProcessor] Batch None completed successfully: 108 objects (identity: 40, marking-definition: 1, malware: 1, relationship: 45, location: 17, intrusion-set: 1, report: 1, attack-pattern: 1, vulnerability: 1)",
        "[GenericBatchProcessor] Successfully processed batch #1. Total STIX objects sent: 108",

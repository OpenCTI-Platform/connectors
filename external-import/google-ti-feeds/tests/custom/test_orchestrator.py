...
def expected_threat_actor_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 32, 'entity_type': 'Campaigns'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorThreatActor]', 'current': 1, 'total': 1, 'entities_count': 172, 'entities_summary': 'location: 23, identity: 34, intrusion-set: 1, relationship: 85, malware: 1, vulnerability: 1, software: 24, note: 1, campaign: 1, attack-pattern: 1'}",
        ...
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 174, 'type_summary': 'identity: 35, marking-definition: 1, location: 23, intrusion-set: 1, relationship: 85, malware: 1, vulnerability: 1, software: 24, note: 1, campaign: 1, attack-pattern: 1'}",
...
def expected_malware_family_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 32, 'entity_type': 'Campaigns'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorMalware]', 'current': 1, 'total': 1, 'entities_count': 172, 'entities_summary': 'identity: 34, malware: 1, relationship: 85, location: 23, intrusion-set: 1, vulnerability: 1, software: 24, note: 1, campaign: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 172, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 172, 'total_count': 172, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 174, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 174, 'display_name': 'STIX objects', 'total_processed': 174}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 174, 'type_summary': 'identity: 35, marking-definition: 1, malware: 1, relationship: 85, location: 23, intrusion-set: 1, vulnerability: 1, software: 24, note: 1, campaign: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 174 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 174}",
...
def expected_vulnerability_log_messages_no_software() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 32, 'entity_type': 'Campaigns'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 124, 'entities_summary': 'vulnerability: 1, note: 1, identity: 34, malware: 1, relationship: 61, location: 23, intrusion-set: 1, campaign: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 124, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 124, 'total_count': 124, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 126, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 126, 'display_name': 'STIX objects', 'total_processed': 126}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 126, 'type_summary': 'identity: 35, marking-definition: 1, vulnerability: 1, note: 1, malware: 1, relationship: 61, location: 23, intrusion-set: 1, campaign: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 126 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 126}",
...
def expected_vulnerability_log_messages() -> list[str]:
    ...
    return [
        ...
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 32, 'entity_type': 'Campaigns'}",
        "Converted entities to STIX format - {'prefix': '[GenericConverter]', 'count': 2, 'entity_type': 'attack techniques'}",
        "Converted to STIX entities - {'prefix': '[OrchestratorVulnerability]', 'current': 1, 'total': 1, 'entities_count': 172, 'entities_summary': 'vulnerability: 1, software: 24, note: 1, relationship: 85, identity: 34, malware: 1, location: 23, intrusion-set: 1, campaign: 1, attack-pattern: 1'}",
        "Adding items to batch processor - {'prefix': '[GenericBatchProcessor]', 'count': 172, 'display_name': 'STIX objects'}",
        "Successfully added items - {'prefix': '[GenericBatchProcessor]', 'added_count': 172, 'total_count': 172, 'display_name': 'STIX objects'}",
        "Flushing remaining items - {'prefix': '[GenericBatchProcessor]', 'count': 174, 'display_name': 'STIX objects'}",
        "Processing batch - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'batch_size': 174, 'display_name': 'STIX objects', 'total_processed': 174}",
        "Sent batch to OpenCTI - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1}",
        "Batch completed successfully - {'prefix': '[GenericBatchProcessor]', 'work_id': None, 'total_count': 174, 'type_summary': 'identity: 35, marking-definition: 1, vulnerability: 1, software: 24, note: 1, relationship: 85, malware: 1, location: 23, intrusion-set: 1, campaign: 1, attack-pattern: 1'}",
        "Successfully processed batch #1. Total STIX objects sent: 174 - {'prefix': '[GenericBatchProcessor]', 'batch_num': 1, 'total_items_sent': 174}",
        "State update: Setting next_cursor_date - {'prefix': '[GenericBatchProcessor]', 'latest_date': '2025-06-25T08:22:55+00:00'}",
    ]

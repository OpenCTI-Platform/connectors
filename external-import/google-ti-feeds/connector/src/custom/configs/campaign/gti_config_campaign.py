...
class GTICampaignConfig(GTIBaseConfig):
    ...
    campaign_import_start_date: str = Field(
        default="P30D",
        description="ISO 8601 duration string specifying how far back to import campaigns (e.g., P1D for 1 day, P30D for 30 days)",

"""GTI batch processor configuration for campaigns.

This module defines configuration for batch processing GTI campaign STIX objects
...
def campaign_extract_stix_date(stix_object: Any) -> Any | None:
    ...
    Ignores all other object types (identity, location, etc.).
    ...
    """
    return extract_stix_date_for_type("campaign")(stix_object)

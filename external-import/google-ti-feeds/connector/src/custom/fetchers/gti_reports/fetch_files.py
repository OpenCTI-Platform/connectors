...
# TODO:    Scenario Outline: Should call the endpoint '/collections/{id}/relationships/files'.
...
# TODO:    Scenario Outline: Should report, at least in log, how many files retrieved.
# TODO:    Scenario Outline: Should map gti files response into a pydantic model for ease of use.

...
# TODO:    Scenario Outline: Should call the endpoint '/collections/{id}/relationships/ip_addresses'.
...
# TODO:    Scenario Outline: Should report, at least in log, how many ip addressesretrieved.
# TODO:    Scenario Outline: Should map gti ip addresses response into a pydantic model for ease of use.

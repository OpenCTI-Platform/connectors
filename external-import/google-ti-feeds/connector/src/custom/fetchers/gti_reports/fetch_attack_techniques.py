...
# TODO:   Scenario Outline: Should call the endpoint '/collections/{id}/relationships/attack_techniques'.
...
# TODO:   Scenario Outline: Should report, at least in log, how many attack techniques retrieved.
# TODO:   Scenario Outline: For each attack techniques id retrieved call the endpoint '/collections/{id}'.
# TODO:   Scenario Outline: If the API response is not a json, need to raise an error.
# TODO:   Scenario Outline: If the API didn't respond, like a network error, should retry a few times.
# TODO:   Scenario Outline: Should map gti attack techniques response into a pydantic model for ease of use.

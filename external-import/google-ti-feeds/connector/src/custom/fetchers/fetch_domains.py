...
# TODO:    Scenario Outline: Should call the endpoint '/collections/{id}/relationships/domains'.
...
# TODO:    Scenario Outline: Should report, at least in log, how many domains retrieved.
# TODO:    Scenario Outline: Should map gti domains response into a pydantic model for ease of use.

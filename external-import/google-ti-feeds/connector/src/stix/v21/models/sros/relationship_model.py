...
def test_relationship_model() -> None:
    """Test function to demonstrate the usage of RelationshipModel."""
    ...
    full = RelationshipModel(
        ...
        source_ref=f"intrusion-set--{uuid4()}",
        target_ref=f"identity--{uuid4()}",
        description="APT Group X has been targeting Energy sector organizations since 2019",
        ...
        external_references=[
            {
                ...
                "url": "https://example.org/blog/apt-x-energy-sector",
                "description": "Analysis of APT X campaigns against energy sector",
            }
        ],
        ...
        custom_properties={"x_analysis_priority": "high"},
    )

    print("\n=== FULL RELATIONSHIP ===")  # noqa: T201

...
| Google Threat Intel Malware Extra Query Filters        | `gti.malware_family_extra_filters`           | `GTI_MALWARE_FAMILY_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching malwares e.g., {'name': 'Emotet'}. |

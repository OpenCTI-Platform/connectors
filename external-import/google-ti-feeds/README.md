...
| Google Threat Intel Report Extra Query Filters        | `gti.report_extra_filters`           | `GTI_REPORT_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching reports e.g., {'name': 'phishing'}. |
...
| Google Threat Intel Threat Actor Extra Query Filters        | `gti.threat_actor_extra_filters`           | `GTI_THREAT_ACTOR_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching threat actors e.g., {'name': 'APT28'}. |
...
| Google Threat Intel Campaigns Extra Query Filters        | `gti.campaign_extra_filters`           | `GTI_CAMPAIGN_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching campaigns e.g., {'name': 'Operation Shadow'}. |
...
| Google Threat Intel Malware Extra Query Filters        | `gti.malware_family_extra_filters`           | `GTI_MALWARE_FAMILY_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching malware families e.g., {'name': 'Emotet'}. |
...
| Google Threat Intel Vulnerability Extra Query Filters        | `gti.vulnerability_extra_filters`           | `GTI_VULNERABILITY_EXTRA_FILTERS`           | None | No        | Optional dictionary of additional filters to add to query when fetching vulnerabilities e.g., {'name': 'CVE-2024'}. |

...
| Google Threat Intel Report Origins                  | `gti.report_origins`                 | `GTI_REPORT_ORIGINS`                 | All                               | No        | The origin of the reports to import from Google Threat Intel. Can be a string separated by comma for multiple values. Valid values are: `All`, `partner`, `crowdsourced`, `google threat intelligence`.                                                                                                                                                                                                                                                                                                                                                   |
...
| Google Threat Intel Threat Actors  Origins          | `gti.threat_actor_origins`           | `GTI_THREAT_ACTOR_ORIGINS`           | All                               | No        | The origin of the Threat Actors to import from Google Threat Intel. Can be a string separated by comma for multiple values. Valid values are: `All`, `partner`, `crowdsourced`, `google threat intelligence`.                                                                                                                                                                                                                                                                                                                                             |
...
| Google Threat Intel Campaign Origins                | `gti.campaign_origins`               | `GTI_CAMPAIGN_ORIGINS`               | All                               | No        | The origin of the Campaigns to import from Google Threat Intel. Can be a string separated by comma for multiple values. Valid values are: `All`, `partner`, `crowdsourced`, `google threat intelligence`.                                                                                                                                                                                                                                                                                                                                              |
...
| Google Threat Intel Malware Family Origins          | `gti.malware_family_origins`           | `GTI_MALWARE_FAMILY_ORIGINS`           | All                               | No        | The origin of the Malware Family to import from Google Threat Intel. Can be a string separated by comma for multiple values. Valid values are: `All`, `partner`, `crowdsourced`, `google threat intelligence`.                                                                                                                                                                                                                                                                                                                                             |
...
| Google Threat Intel Vulnerability Origins           | `gti.vulnerability_origins`          | `GTI_VULNERABILITY_ORIGINS`          | All                               | No        | The origin of the Vulnerabilities to import from Google Threat Intel. Can be a string separated by comma for multiple values. Valid values are: `All`, `partner`, `crowdsourced`, `google threat intelligence`.                                                                                                                                                                                                                                                                                                                                          |

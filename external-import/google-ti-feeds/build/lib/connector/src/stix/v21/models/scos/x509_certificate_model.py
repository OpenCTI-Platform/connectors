...
class X509V3ExtensionsTypeModel(BaseModel):
    ...
    private_key_usage_period_not_before: datetime | None = Field(
        default=None,
        description="Start of private key usage period, if different from cert validity.",
    )
    private_key_usage_period_not_after: datetime | None = Field(
        default=None,
...
class X509CertificateModel(BaseSCOModel):
    ...
    validity_not_before: datetime | None = Field(
        default=None, description="Start of certificate validity period."
    )
    validity_not_after: datetime | None = Field(
    ...
    x509_v3_extensions: X509V3ExtensionsTypeModel | None = Field(
        default=None,

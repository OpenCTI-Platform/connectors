# OpenCTI BitSight Incidents External Import Connector
...
The BitSight Incidents connector fetches actionable alerts from the Cybersixgill API and converts them to STIX 2.1 bundles for ingestion into OpenCTI. It supports both single-tenant and multi-tenant modes.
...
| Connector Name  | name            | `CONNECTOR_NAME`             | BitSight Incidents | No        | Name of the connector.                                         |

...
```
connector-sekoia:
    image: opencti/connector-sekoia:6.8.12
    environment:
      ...
      - SEKOIA_CONFIDENCE_SCORE=null #Optional, This will be the score assigned to the indicators. Defaults to null, maximum 100.
    restart: always
    depends_on:
      - opencti

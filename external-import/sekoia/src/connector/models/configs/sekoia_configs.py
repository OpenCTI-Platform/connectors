...
class _ConfigLoaderSekoia(ConfigBaseSettings):
    ...
    start_date: Optional[str] = Field(
        default=None,
        description="The date to start consuming data from. Maybe in the formats YYYY-MM-DD or YYYY-MM-DDT00:00:00.",
    )
    ...
    import_source_list: Optional[bool] = Field(
        default=False,
        description="Create the list of sources observed by Sekoia as label.",
    )
    import_ioc_relationships: Optional[bool] = Field(
        default=True,

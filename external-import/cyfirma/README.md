# OpenCTI External Ingestion CYFIRMA Connector

Table of Contents

- [OpenCTI External Ingestion CYFIRMA Connector](#opencti-external-ingestion-cyfirma-connector)
...
The CYFIRMA connector allows OpenCTI to import threat intelligence indicators and observables directly from the CYFIRMA API.
...
| Connector Name  | name       | `CONNECTOR_NAME`            | CYFIRMA         | Yes       | Name of the connector.                                                                   |
| Connector Scope | scope      | `CONNECTOR_SCOPE`           | cyfirma         | Yes       | The scope or type of data the connector is importing, either a MIME type or Stix Object. |

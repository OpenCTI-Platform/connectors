...
| Connector Scope           | `scope`           | `CONNECTOR_SCOPE`                    | vulnerability,malware,threat-actor,infrastructure,location,ip-addr,indicator,external-reference,software,attack-pattern,course-of-action     | No          | The scope of data to import, a list of Stix Objects.                          |
...
Example, `pycti==6.7.20`. If you don't, it will take the latest version, but

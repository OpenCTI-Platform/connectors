...
import pytest
from ossf_malicious_packages.connector import OSSFMaliciousPackagesConnector
        ...
        return handler(
            {
                ...
                "ossf": {
                    "github_repo_url": "https://github.com/ossf/malicious-packages",
                    "branch": "main",
                    "local_repo_path": "/opt/ossf-malicous-packages-repo",
                    "default_score": 80,
...
def test_connector_is_instantiated(mock_opencti_connector_helper):
    ...
    connector = OSSFMaliciousPackagesConnector(config=settings, helper=helper)

...
| Connector Duration Period | duration_period | `CONNECTOR_LOG_LEVEL`       |                                      | Yes       | Interval given for scheduler process in ISO-8601 format. The most that these feeds are updated is hourly |

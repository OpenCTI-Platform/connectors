...
| Connector Type                 | `type`                                       | `CONNECTOR_TYPE`                                         | `EXTERNAL_IMPORT`   | No        | `EXTERNAL_IMPORT`                            | Must be `EXTERNAL_IMPORT`.                                                  |
...
| Parameter                         | config.yml                          | Docker environment variable                          | Default                                      | Mandatory | Example                                      | Description                                                                 |
| --------------------------------- | ----------------------------------- | ---------------------------------------------------- | -------------------------------------------- | --------- | -------------------------------------------- | --------------------------------------------------------------------------- |
| API base URL                      | `baseurl`                           | `RST_THREAT_LIBRARY_BASEURL`                         | `https://api.rstcloud.net/v1`                | No        | `https://api.rstcloud.net/v1`                | RST Cloud API root.                                                         |
...
| OpenCTI push max retries          | `max_retries`                       | `RST_THREAT_LIBRARY_MAX_RETRIES`                     | `3`                                          | No        | `3`                                          | Attempts when pushing to OpenCTI (minimum 1).                               |
| OpenCTI push retry delay          | `retry_delay`                       | `RST_THREAT_LIBRARY_RETRY_DELAY`                     | `10`                                         | No        | `10`                                         | Initial retry delay in seconds (minimum 1s between OpenCTI push retries).   |
...
| OpenCTI push batch size           | `opencti_batch_size`                | `RST_THREAT_LIBRARY_OPENCTI_BATCH_SIZE`              | `200`                                        | No        | `200`                                        | Max objects per OpenCTI push (large deltas are flushed in chunks).          |

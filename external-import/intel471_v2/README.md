...
### Step 1: Prepare
* Ensure you have created an **Application** in the **Intel471 portal** and noted the **Client ID** and **Client secret** from that application (those are your _Verity471 API_ credentials).

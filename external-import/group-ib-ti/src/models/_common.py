...
class StixPayloadUtils:
    ...
    @staticmethod
    def _generate_tlp_obj(color: str | None) -> Any:
        if not color:
    ...
    @staticmethod
    def _generate_main_observable_type(obj_type: str) -> str | None:
    ...
    @staticmethod
    def _generate_stix_report_type(report_type: str) -> str | None:
...
class BaseEntity(StixPayloadUtils):
    def __init__(
        ...
        self.stix_indicator: Any = None
        self.stix_observable: Any = None
        self.stix_sdo: Any = None
        self.stix_common: Any = None
        self.stix_relationships: list[Any] = []

        self.external_references: list[Any] = []

        self.stix_main_object: Any = None
    ...
    def _generate_external_reference(
        self, ref_id: str | None, ref_url: str, ref_desc: str
    ) -> Any:
    ...
    def generate_external_references(
        self, reference_objects: list[tuple[str | None, str, str]]
...
class _BaseIndicator(BaseEntity):
    ...
    def _create_pattern(self, pattern_name: str | list[str]) -> str | None:
        return None

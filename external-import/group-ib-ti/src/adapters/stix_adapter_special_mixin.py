...
class StixAdapterSpecialMixin(SdoMixin):
    ...
    def _build_cnc_observable_set(
        ...
        def _make_file(
            file_dict: dict[str, Any] | None, is_primary: bool
        ) -> Any | None:
    ...
    def _build_chat_message_bundle(
        ...
        msg_portal_links: list[tuple[str | None, str, str]] = list(
            portal_links_extra or []
        )

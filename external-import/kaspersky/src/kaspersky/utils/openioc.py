...
from kaspersky.utils.stix2 import (
    OBSERVATION_FACTORY_DOMAIN_NAME, OBSERVATION_FACTORY_EMAIL_ADDRESS,
    ...
    OBSERVATION_FACTORY_FILE_SHA256, OBSERVATION_FACTORY_HOSTNAME,
    OBSERVATION_FACTORY_IP_ADDRESS, OBSERVATION_FACTORY_MUTEX,
    OBSERVATION_FACTORY_NETWORK_ACTIVITY, OBSERVATION_FACTORY_URL,

...
from kaspersky.utils.common import (convert_comma_separated_str_to_list,
...
from kaspersky.utils.stix2 import (DEFAULT_TLP_MARKING_DEFINITION, Observation,
                                   ObservationConfig, ObservationFactory,
                                   create_country, create_file_pdf,
                                   create_indicates_relationships,
                                   create_indicator, create_intrusion_set,
                                   create_object_refs, create_organization,
                                   create_region, create_report, create_sector,
